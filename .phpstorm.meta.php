...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/mariusz/Herd/dziennik2/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/mariusz/Herd/dziennik2/public/storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','generated::m6Gw0R2YgIVhxD6k','generated::xznOCLcbRCpORkKU','generated::o83dcfXSSwshp2PD','generated::s3XICC7Bz7q9Pj9E',
'generated::iSWFtvuEZqU8Fb2s','livewire.update','generated::P8W9BQb45VbaMNq4','generated::OAKxcVftXn7UbH44','livewire.upload-file',
'livewire.preview-file','generated::D0sHYUisp2IoKeVm','home','login','register',
'logout','delete.account','settings','subjects','subjects.create',
'grades','tasks','tasks.create','storage.local',);
        registerArgumentsSet('views', 
'app','auth.login','auth.register','components.fav-subject-home-page','components.footer',
'components.off-canvas-sidebar','components.sidebar','grades.grades','home','livewire.add-new-subject',
'livewire.delete-subject','livewire.favorite-subjects-sidebar','livewire.favourite-toggle','livewire.grades-manager','livewire.login',
'livewire.modals.task-modal','livewire.register','livewire.settings.account-section','livewire.settings.minimal-average-section','livewire.tasks.add-task',
'livewire.tasks.delete-task','settings','subjects.addNewSubject','subjects.subject','tasks.task',
'tasks.taskManager','e60dd9d2c3a62d619c9acb38f20d5aa5::accent','e60dd9d2c3a62d619c9acb38f20d5aa5::aside','e60dd9d2c3a62d619c9acb38f20d5aa5::avatar.group','e60dd9d2c3a62d619c9acb38f20d5aa5::avatar.index',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','validation.failed',);
